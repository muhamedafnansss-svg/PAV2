...
_APP_ALIASES = {
    ...
    "calculator": "calc.exe",
    "calc": "calc.exe",
    "browser": "start https://google.com" if IS_WINDOWS else "xdg-open https://google.com",
    "chrome": "start chrome",
    "firefox": "start firefox",
    "explorer": "explorer.exe" if IS_WINDOWS else "xdg-open .",
    "file manager": "explorer.exe",
    "terminal": "wt.exe" if IS_WINDOWS else "x-terminal-emulator",
    "cmd": "cmd.exe",
